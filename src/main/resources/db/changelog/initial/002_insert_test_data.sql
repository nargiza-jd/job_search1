...
INSERT INTO vacancies (id, title, description, salary, category, company, location, experience_from, experience_to, published, company_id) VALUES
                                                                                                                                               (1, 'Backend Developer', 'Spring Boot, PostgreSQL required', 1200, 'IT', 'TechSoft', 'Bishkek', 1, 3, true, 2),
                                                                                                                                               (2, 'UI/UX Designer', 'Experience with Figma and Adobe XD', 1100, 'Design', 'DesignPro', 'Osh', 0, 2, true, 2);
